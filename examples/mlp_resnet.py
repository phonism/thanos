...
def train_mnist(
    ...
    if use_cuda:
        device = thanos.cuda()
    train_dataloader = data.DataLoader(train_dataset, batch_size=batch_size, shuffle=True, device=device)
    test_dataloader = data.DataLoader(test_dataset, device=device)
